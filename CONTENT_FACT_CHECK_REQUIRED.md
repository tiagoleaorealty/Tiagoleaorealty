# Claims requiring professional verification (do not treat as confirmed)
Site content states these as fact; each needs sign-off from a licensed Costa Rican professional (attorney / CPA / immigration specialist) before being treated as verified. Until then they carry the on-page disclaimer + sources block.

## Immigration (residency article) — verify with an immigration attorney
- Inversionista: property must be held **personally** (not via corporation) to qualify; $150,000 threshold current under Law 9996
- Rentista: $2,500/mo unearned income OR $60,000 deposit structure; ongoing $2,500/mo exchange obligation
- Pensionado: $1,000/mo lifetime pension; 401(k)/IRA withdrawals do NOT qualify
- Work restrictions during temporary residency; remote-work gray area framing
- Permanent residency after 3 years; citizenship after 7 (+Spanish/civics test); dual citizenship allowed
- Tourist entry 180 days; legal stay after filing application
- CAJA: 9–11% of declared income; example amounts ($100–150 pensionado, $200–350 rentista); free spouse/child coverage

## Tax (closing-costs & sellers guide) — verify with a CR accountant
- 2.5% non-resident withholding mechanics
- Pre-2019 purchase: 2.25%-of-gross capital-gains election
- Primary-residence capital-gains exemption
- Transfer tax ~1.5%; annual property tax 0.25%; Luxury Home Tax thresholds
- Corporation share-transfer treatment; 13% VAT on commissions and tourism rentals; ICT registration for short-term rentals

## Legal (titled vs concession) — verify with a real-estate attorney
- Maritime Zone 200m rule; concession foreign-ownership restrictions (49% rule wording)

## Data / market claims (Tiago to confirm or source)
- Mareas I bedroom count (name says 6; DB currently 5 — SQL provided)
- Casa Hanna bathroom count (DB: 5)
...
- 2026-09-20: at Tiago's request the article now carries 18 outbound listing cards linking to krainrealestate.com/home-search pages (the ones he showed in the reel). They are links only — nothing is scraped, no KRAIN photos or copy are reproduced, and the cards carry rel="noopener nofollow". The listing NAMES come from the URL slugs; no prices are stated, because KRAIN is behind Cloudflare and prices could not be read or kept current. Cards go stale as listings sell — Tiago should ask for a refresh periodically. 2026-09-20: cards became a horizontal rail with a hero photo, and all 18 now have one. The four KRAIN listings (Casa Tatou, Casa Mikella, Casa Suerte, Casa Del Sol 22) use the photos already in his Supabase storage; the other 14 heroes were saved into listing-photos/ by scripts/fetch-listing-photos.py. **Tiago states he shot all of these himself as the photographer for the listing brokerages**, which is why his own site can use them — the MLS feed is just where they are served from. The feed's URLs are signed and rotate, so the post references the local copies, never the feed. The house rule against IMPORTING other brokerages' /home-search/ listings into the property database is untouched. The house rule against IMPORTING /home-search listings is untouched.
- Photos: town-tamarindo.jpg (also the cover), town-potrero.jpg and town-coco.jpg (supplied 2026-09-20, replacing an earlier watermarked Mytanfeet image that was rejected and never used)
