...
- 2026-09-20: at Tiago's request the article now carries 18 outbound listing cards linking to krainrealestate.com/home-search pages (the ones he showed in the reel). They are links only — nothing is scraped, no KRAIN photos or copy are reproduced, and the cards carry rel="noopener nofollow". The listing NAMES come from the URL slugs; no prices are stated, because KRAIN is behind Cloudflare and prices could not be read or kept current. Cards go stale as listings sell — Tiago should ask for a refresh periodically. The house rule against IMPORTING /home-search listings is untouched.
