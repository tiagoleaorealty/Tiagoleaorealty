<!--
PASTE-READY BLOG POST — Schools guide.

The database is locked to logged-in writes now, so this cannot be inserted for
you. Open admin.html > Blog Posts > + New Post and copy each field below.
Keep Status = Draft until you have read it through.

Delete this file once the post is live in Supabase — the post lives in the
database, not in the repo, and a second copy here will drift out of date.
-->
...
## BODY (paste everything below this line into the Article Body box)
